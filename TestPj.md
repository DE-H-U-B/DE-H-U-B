...
print("User " ..UserPy.."  ใช้งาน")
print(UserPy)

local url = "https://discord.com/api/webhooks/1103189846270423040/ZNadEJEwe7L1JOc6_dBMHu-jEzFgo_YQyL96AzoRUilWiyY68QfZlUmCnwoicP9aUWkM" -- ur webhook url
local data = {
...
["embeds"] = {
{
["description"] = "เลเวล : " ..Levelplayer .."  User :" ..UserPy.. "   ใช้งานสคริป",
...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://9300408058"
        ...
        spawn(function()
            while wait(.1) do 
                pcall(function()
                    for u = 1,255 do --255
                        wait()
                        BindButton.TextColor3 = Color3.fromHSV(u/255, 1, 1) --(u/255, 1, 1)
                        wait()
                    end
                end)
            end
        ...
        spawn(function()
            pcall(function()
                while wait() do 
                    for u = 1,255 do --255
                        wait()
                        --Name.TextColor3 = Color3.fromHSV(u/255, 1, 1) --255 wait() Hub.TextColor3 = Color3.fromHSV(u/255, 1, 1) --255 wait()
                        BindButton.TextColor3 = Color3.fromHSV(u/255, 1, 1) --(u/255, 1, 1)
                        wait()
                    end
                end
...
spawn(function()
    while wait() do 
        for i = 1,255 do --255
            TabButton.TextColor3 = Color3.fromHSV(i/255, 1, 1) --255
            wait()
        end
    end
end)
		...
		function main:Button(text,callback)
            ...
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    TextBtn.TextColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
			        end)
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    Label.TextColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
        end)
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    Item.TextColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
        end)
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    SliderLabel.TextColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
        end)
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    bar1.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                    bar1.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                    bar1.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    slidervalue.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
        end)
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    TextboxLabel.TextColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
        end)
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    Sep1.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
        end)
            ...
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    Sep2.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                    Sep3.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
			        end)
        ...
        spawn(function()
            while wait() do 
                for u = 1,255 do --255
                    wait()
                    Line.BackgroundColor3 = Color3.fromHSV(u/255, 1, 1) --255
                    wait()
                end
            end
        end)
...
MODILEMAGE.Image = "rbxassetid://9300408058"
...
Main:Label("Discord Developer : MARK#9682")

Time = Main:Label("Server Time")
Client = Main:Label("Server Pring Fps")
    ...
    local AutoFarm = Main:Toggle("Auto Farm Level",_G.AutoFarm,function(value)
        ...
        Main:Toggle("Auto KaiTun | Bate",false,function(value)
       _G.AutoFarm = value
      ...
      StopTween(_G.AutoFarm)
        ...
        Main:Toggle("Auto Chest",getgenv().Chest,function(vu)
        getgenv().Chest = vu
    end)

loadstring(game:HttpGet('https://pastebin.com/raw/gGYufZdi'))()
print("loadstring-CheckQuest.Ok")

-- [Check Quest]

function CheckQuestAutoFarm()
	...
	if World1 then
		...
		elseif L_159_ == 10 or L_159_ <= 14 then -- Monkey
		    _G.asdfjkghjfjdgfhgsdhjfgh = nil
			LevelFarm = _G.asdfjkghjfjdgfhgsdhjfgh
			...
			--CFrameSetPoint = CFrame.new(-1338.24976, 12.6999941, 498.668396, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247)
			
		elseif L_159_ == 15 or L_159_ <= 29 then -- Gorilla
		    _G.asdfjkghjfjdgfhgsdhjfgh = 2
			LevelFarm = _G.asdkjasdsasdfdasdasd
_G.asdkjasdsasdfdasdasd = 3
			Name = "Gorilla [Lv. 20]"
			...
			CFrameMon1 = CFrame.new(-1129.86926, 54.7979355, -484.778076, 0.997488856, -6.87308699e-08, 0.07082358, 6.88999648e-08, 1, 5.53450584e-11, -0.07082358, 4.82453633e-09, 0.997488856)
			...
			--CFrameSetPoint = CFrame.new(-1338.24976, 12.6999941, 498.668396, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247)
            --[[if getgenv().Bypass and Auto_Farm_Level and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1500 then
                game:GetService("RunService"):Set3dRenderingEnabled(true)
            end]]
		elseif L_159_ == 30 or L_159_ <= 39 then -- Pirate
		    _G.asdkjasdsasdfdasdasd = nil
		    _G.asdfjkghjjfjdjsgfhgsdhjfgh = nil
			LevelFarm = _G.asdfjkghjjfjdjsgfhgsdhjfgh --nil
			...
			CFrameMon1 = CFrame.new(-1245.51672, 22.8722248, 3910.09277, -0.446995169, 1.5857319e-08, -0.894536376, 4.25287139e-09, 1, 1.5601719e-08, 0.894536376, 3.16954485e-09, -0.446995169)
			VectorMon = Vector3.new(- 1115, 14, 3938)

			CFrameQuest = CFrame.new(- 1140, 5, 3828)
			VectorQuest = Vector3.new(- 1140, 5, 3828)
		elseif L_159_ == 40 or L_159_ <= 59 then -- Brute
		    _G.asdfjkghjjfjdjsgfhgsdhjfgh = 4
			LevelFarm = _G.asdkjasdsasdfdasdasdasd --5
_G.asdkjasdsasdfdasdasdasd = 5
			Name = "Brute [Lv. 45]"
			...
			CFrameMon = CFrame.new(-1348.0592, 14.869874, 4258.35938, -0.741224289, 0, -0.671257436, 0, 1, 0, 0.671257436, 0, -0.741224289)
			--(- 1145, 15, 4350)
			CFrameMon1 = CFrame.new(-971.697998, 14.869875, 4305.97021, -0.994425237, 0, 0.105443843, 0, 1, 0, -0.105443843, 0, -0.994425237)
			VectorMon = Vector3.new(- 1146, 15, 4350)

			CFrameQuest = CFrame.new(- 1140, 5, 3828)
			VectorQuest = Vector3.new(- 1140, 5, 3828)
		elseif L_159_ == 60 or L_159_ <= 74 then -- Desert Bandit
		    _G.asdkjasdsasdfdasdasdasd = nil
			LevelFarm = 6--6
			...
			CFrameMon1 = CFrame.new(932, 39.3992081, 4484, 1, 0, 0, 0, 1, 0, 0, 0, 1)
		...
		elseif L_159_ == 75 or L_159_ <= 89 then -- Desert Officre
			...
			CFrameMon1 = CFrame.new(1618.86816, 37.19133, 4373.3457, 0.471173078, 0, -0.882040799, 0, 1, 0, 0.882040799, 0, 0.471173078)
		...
		elseif L_159_ == 90 or L_159_ <= 99 then -- Snow Bandits
		    _G.asdfjkjjfjdjsgfhgsdhjf = nil
			LevelFarm = _G.asdfjkjjfjdjsgfhgsdhjf
			...
			CFrameMon = CFrame.new(1373.67688, 105.821022, -1419.44873, 0.981652617, -7.50422586e-08, 0.190678105, 8.49819415e-08, 1, -4.39509513e-08, -0.190678105, 5.93487606e-08, 0.981652617)
			CFrameMon1 = CFrame.new(1248.23901, 120.031258, -1364.77014, -0.985072255, -5.32813331e-08, -0.172141492, -7.03836562e-08, 1, 9.3246868e-08, 0.172141492, 1.03970848e-07, -0.985072255)
		...
		elseif L_159_ == 100 or L_159_ <= 119 then -- Snowman
		    _G.asdfjkjjfjdjsgfhgsdhjf = 8
			LevelFarm = _G.asdkjasdsasdfdasdasdasdasfdasd--9
			_G.asdkjasdsasdfdasdasdasdasfdasd = 9
			...
			CFrameMon = CFrame.new(1291.24878, 150, -1462.65918, 0.383833647, 0, -0.923402727, 0, 1.00000012, 0, 0.923402727, 0, 0.383833647)
			CFrameMon1 = CFrame.new(1040.44653, 150, -1574.55859, -0.0156812146, 0, 0.99987644, 0, 1.00000012, 0, -0.99987644, 0, -0.0156812146)
			--CFrameMon = CFrame.new(1289, 150, - 1442)
			VectorMon = Vector3.new(1289, 106, - 1442)

			CFrameQuest = CFrame.new(1386, 87, - 1297)
			VectorQuest = Vector3.new(1386, 87, - 1297)
			_G.asdfjkghjjfjdjsgsadfhgs = nil
		elseif L_159_ == 120 or L_159_ <= 149 then -- Chief Petty Officer
		    _G.asdkjasdsasdfdasdasdasdasfdasd = nil
		    _G.asdfjkghjjfjdjsgsadfhgs = nil
			LevelFarm = _G.asdfjkghjjfjdjsgsadfhgs --10
        ...
        --else
			...
			CFrameMon = CFrame.new(-4916.93994, 38.0000305, 4122.47021, -0.258548856, 0, -0.965998173, 0, 1, 0, 0.965998173, 0, -0.258548856)
			CFrameMon1 = CFrame.new(-4787.04053, 60.239151, 4478.31592, 0.965997219, -0, -0.258552492, 0, 1, -0, 0.258552492, 0, 0.965997219)
			_G.asdfjkghjjfjdjsgfhgs = nil
			_G.asdfjkghjjfjdjsgsadfhgs = nil
		elseif L_159_ == 150 or L_159_ <= 174 then -- Sky Bandit
            _G.asdfjkghjjfjdjsgsadfhgs = 10
			LevelFarm = _G.asdfjkghjjfjdjsgfhgs--11
			...
			CFrameMon = CFrame.new(-5065.21484, 312.297821, -2859.33276, -0.906767309, 0, -0.421631455, 0, 1, 0, 0.421631455, 0, -0.906767309)--(- 4981, 278, - 2830)
			CFrameMon1 = CFrame.new(-4911.65234, 319.427063, -2846.41187, -0.971421778, 0, -0.237359866, 0, 1, 0, 0.237359866, 0, -0.971421778)--(-5035.11377, 278.067444, -2846.45776, 0.965008676, 3.46573295e-08, -0.262217969, -3.31216441e-08, 1, 1.02764002e-08, 0.262217969, -1.2317255e-09, 0.965008676)
			VectorMon = Vector3.new(- 4981, 278, - 2830)

			CFrameQuest = CFrame.new(- 4842, 718, - 2623)
			VectorQuest = Vector3.new(- 4842, 718, - 2623)
			_G.asdfjkghjjfjdjsgsdfdsffhgs = nil
		elseif L_159_ == 175 or L_159_ <= 189 then -- Dark Master
		    _G.asdfjkghjjfjdjsgfhgs = 11
			LevelFarm = _G.asdfjkghjjfjdjsgsdfdsffhgs --12
			...
			CFrameMon1 = CFrame.new(-5222.56201, 430.427094, -2277.24341, 0.201176316, -2.91352875e-09, 0.97955507, -4.26868496e-08, 1, 1.17411592e-08, -0.97955507, -4.41761614e-08, 0.201176316)
			VectorMon = Vector3.new(- 5250, 389, - 2272)

			CFrameQuest = CFrame.new(- 4842, 718, - 2623)
			VectorQuest = Vector3.new(- 4842, 718, - 2623)
			 _G.dfjkjjfjdjsgfhhjf = nil
		elseif L_159_ == 190 or L_159_ <= 209 then -- Dark Master
		    _G.asdfjkghjjfjdjsgsdfdsffhgs = 12
            _G.dfjkjjfjdjsgfhhjf = nil
			LevelFarm = _G.dfjkjjfjdjsgfhhjf
			...
			CFrameMon = CFrame.new(4983.14111, 45.9660225, 568.560425, -0.36942631, -1.98047956e-09, 0.929260015, 2.3051145e-08, 1, 1.12952012e-08, -0.929260015, 2.5593252e-08, -0.36942631)
			CFrameMon1 = CFrame.new(5135.9126, 22.5601292, 461.483063, 0.73926723, -1.94744949e-08, -0.673412144, 7.32638412e-08, 1, 5.15094101e-08, 0.673412144, -8.74159838e-08, 0.73926723)--(5411, 96, 690)
			VectorMon = Vector3.new(5411, 96, 690)

			CFrameQuest = CFrame.new(5308, 2, 474)
			VectorQuest = Vector3.new(5308, 2, 474)
			_G.asdfjkghjjfjdjsgfhg = nil
		elseif L_159_ == 210 or L_159_ <= 249 then -- Dark Master
		     _G.dfjkjjfjdjsgfhhjf = 12
            _G.asdfjkghjjfjdjsgfhg = nil
			LevelFarm = _G.asdfjkghjjfjdjsgfhg
			...
			CFrameMon = CFrame.new(5591.56348, 21.392025, 881.986755, -0.869124711, 7.17895432e-08, 0.494592994, 5.09402085e-08, 1, -5.56339188e-08, -0.494592994, -2.31581421e-08, -0.869124711)--(5411, 96, 690)
			CFrameMon1 = CFrame.new(5583.13574, 40.3086128, 602.983337, -0.900666356, 1.26320499e-09, -0.434511334, 9.20762244e-10, 1, 9.98605421e-10, 0.434511334, 4.9932869e-10, -0.900666356)
			VectorMon = Vector3.new(5411, 96, 690)
		...
		elseif L_159_ == 250 or L_159_ <= 299 then -- Toga Warrior
			...
			CFrameMon1 = CFrame.new(-2028.85327, 48.843792, -2758.06934, 0.385451078, -7.00912324e-08, -0.92272824, 5.94451492e-08, 1, -5.11288469e-08, 0.92272824, -3.51440512e-08, 0.385451078)
		...
		elseif L_159_ == 300 or L_159_ <= 329 then -- Military Soldier
			...
			CFrameMon1 = CFrame.new(-5279.49561, 34.6354752, 8673.06836, -0.83979696, -1.09422672e-07, -0.542900622, -8.85175879e-08, 1, -6.4626704e-08, 0.542900622, -6.21705532e-09, -0.83979696)
			VectorMon = Vector3.new(- 5408, 11, 8447)

			CFrameQuest = CFrame.new(- 5316, 12, 8517)
			VectorQuest = Vector3.new(- 5316, 12, 8517)
--_G.bvcxcvb = nil
		elseif L_159_ == 330 or L_159_ <= 374 then -- Military Spy ----------------------------------_G.Settings.Configs["Double Quest"]
			LevelFarm = 16
            --NameBoss = "Magma Admiral [Lv. 350] [Boss]"
			...
			LevelQuest = 2
			NameMon = "Military Spy"
            CFrameMon1= CFrame.new(-5630.30859, 107.523697, 8744.48242, -0.175806433, 1.91089686e-08, -0.98442477, 9.11163323e-09, 1, 1.77840764e-08, 0.98442477, -5.8431624e-09, -0.175806433)
		...
		elseif L_159_ == 375 or L_159_ <= 399 then -- Fishman Warrior 
            ...
            CFrameMon1 = CFrame.new(60859, 19, 1501)
		...
		elseif L_159_ == 400 or L_159_ <= 449 then -- Fishman Commando
		    _G.dfjkjjfjdjsgfhhjf = 17
			LevelFarm = _G.asdkjs--18
_G.asdkjs = 18
			...
			CFrameMon1 = CFrame.new(61891, 19, 1470)
		...
		elseif L_159_ == 450 or L_159_ <= 474 then -- God's Guards
			...
			CFrameMon1 = CFrame.new(- 4698, 845, - 1912)
...
_G.asdkjasdsa = 20
			...
			CFrameMon1 = CFrame.new(- 7685, 5567, - 502)
		...
		elseif L_159_ == 525 or L_159_ <= 549 then -- Royal Squad
			...
			CFrameMon1 = CFrame.new(- 7670, 5607, - 1460)
		...
		elseif L_159_ == 550 or L_159_ <= 624 then -- Royal Soldier
		    _G.dfjjdjgfhhjf = 21
			LevelFarm = _G.asdkjasdsasdfd -- 22
_G.asdkjasdsasdfd = 22
			...
			CFrameMon1 = CFrame.new(- 7828, 5607, - 1744)
		...
		elseif L_159_ == 625 or L_159_ <= 649 then -- Galley Pirate
			...
			CFrameMon1 = CFrame.new(5589, 45, 3996)
		...
		elseif L_159_ >= 650 then -- Galley Captain
		    _G.dfjjdjgfhhjf = 23
			LevelFarm = _G.asdkjasdsasdfd --24
			_G.asdkjasdsasdfd = 24
			...
			CFrameMon1 = CFrame.new(5649, 39, 4936)
	...
	if World2 then
		...
		elseif L_159_ == 1425 or L_159_ <= 1449 then -- Sea Soldier [Lv. 1425]
			...
			LevelQuest = 1
			NameMon = "Sea Soldier"
            CFrameMon = CFrame.new(-3366.40918, 46.7432404, -9701.16992, 0.999585688, -8.90842671e-08, 0.0287826434, 8.93453844e-08, 1, -7.78588305e-09, -0.0287826434, 1.03542535e-08, 0.999585688)
			CFrameMon1 = CFrame.new(- 3022, 16, - 9722)
		...
		elseif L_159_ >= 1450 then -- Water Fighter [Lv. 1450]
			...
			CFrameMon1 = CFrame.new(-3508.82788, 238.871872, -10496.8721, -0.97236532, -5.18735774e-08, -0.233464524, -6.1487512e-08, 1, 3.39012942e-08, 0.233464524, 4.73195954e-08, -0.97236532)
	...
	if World3 then
		...
		elseif L_159_ == 2300 or L_159_ <= 2324 then
			...
			CFrameMon = CFrame.new(23.7903595, 102.924995, -12241.6406, -0.951774478, 5.89297002e-08, -0.306798518, 4.89879852e-08, 1, 4.01051103e-08, 0.306798518, 2.31415793e-08, -0.951774478)
			--(231, 23, - 12194)
			CFrameMon1 = CFrame.new(23.7903595, 102.924995, -12241.6406, -0.951774478, 5.89297002e-08, -0.306798518, 4.89879852e-08, 1, 4.01051103e-08, 0.306798518, 2.31415793e-08, -0.951774478) * CFrame.new(0,-80,0)
		...
		elseif L_159_ == 2325 or L_159_ <= 2349 then
			...
			--NameMon = "Cocoa Warrior [Lv. 2300]"
			--NameBoss = "Cocoa Warrior [Lv. 2300]"
			QuestName = "ChocQuest1"

			LevelQuest = 2
			NameMon = "Chocolate Bar Battler"

			CFrameMon = CFrame.new(697.624451, 61.366684, -12627.4082, 0.984009504, 3.88848989e-08, 0.17811583, -5.03436404e-08, 1, 5.98134662e-08, -0.17811583, -6.78240184e-08, 0.984009504)
			--(231, 23, - 12194)
			CFrameMon1 = CFrame.new(697.624451, 61.366684, -12627.4082, 0.984009504, 3.88848989e-08, 0.17811583, -5.03436404e-08, 1, 5.98134662e-08, -0.17811583, -6.78240184e-08, 0.984009504) * CFrame.new(0,-80,0)
			--CFrameMon = CFrame.new(643.8096313476562, 8.544260025024414, -12736.9765625)
			VectorMon = CFrame.new(643.8096313476562, 8.544260025024414, -12736.9765625)
		...
		elseif L_159_ >= 2425 then --2450 MaxLv.
			LevelFarm = 32
			...
			CFrameMon1 = CFrame.new(-849.61377, 14.2855949, -14344.8965, 0.299847752, 3.44731497e-08, 0.953987062, -2.94725755e-08, 1, -2.6872339e-08, -0.953987062, -2.00588453e-08, 0.299847752)
			CFrameMon = CFrame.new(-879.931396, 14.1351166, -14702.5215, 0.315944314, 0, -0.948777735, 0, 1, 0, 0.948777735, 0, 0.315944314)
    ...
    Main:Button("Delete Damage",function()
    ...
    Main:Seperator("Main")
    --local CFrameQuest = loadstring(game:HttpGet("https://pastebin.com/raw/Mxm8i5zT"))()
    spawn(function()
        while wait() do
            if _G.AutoFarm then
                pcall(function()
                    ...
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(Name) then
                                    ...
                                    if v.Name == Name then
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            repeat task.wait()
                                                ...
                                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(3,30,3))
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild(Name) then
                                TP1(game:GetService("ReplicatedStorage"):FindFirstChild(Name).HumanoidRootPart.CFrame * CFrame.new(3,30,3))
                            else
                                if (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 15 then
                                    if PosMon ~= nil then
                                        TP1(PosMon * CFrame.new(3,30,3))
                                    else
                                        if OldPos ~= nil then
                                            TP1(OldPos.Position)
                                        end
...
Type2 = getgenv().Mode
    spawn(function()
        while task.wait(.01) do
            if Type2 == 1 then
                CFrameMonPoD = CFrameMon
            elseif Type2 == 2 then
                CFrameMonPoD = CFrameMon1
            end
        end
    end)
    spawn(function()
                ...
                pcall(function()
                    ...
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                                        ...
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            repeat task.wait()
                                                if v.Humanoid.Health <= HealthMs then
                                                    ...
                                                    topos(v.HumanoidRootPart.CFrame * CFrame.new(3,30,3))
                                                    v.HumanoidRootPart.CanCollide = false
                            ...
                            if Mob then
                                topos(Mob.HumanoidRootPart.CFrame * CFrame.new(3,30,3))
                            else
    ...
    Race:Seperator("Race Menu")

    Race:Toggle("Auto Evo Race",_G.Auto_EvoRace,function(value)
    ...
    Race:Button("Random Rance -3000f",function()
    local args = {
    [1] = "BlackbeardReward",
    [2] = "Reroll",
    [3] = "2"
...
loadstring(game:HttpGet('https://pastebin.com/raw/CG73QwXB'))()
...
a.Run = function(...)
    ...
    Settings:Button("Delete Damage",function()
        game:GetService("ReplicatedStorage").Assets.GUI.DamageCounter.Enabled = false
    end)

        Settings:Toggle("Anti AFK",tru,function(value)
        _G.AFK = value
        end)
...
spawn(function()
    ...
    Tip = Library:Tab("Cradit !")
    
  Tip:Seperator("Discord Developer")
  
  Tip:Button("Copy Link Discord",function()
  setclipboard("https://discord.gg/cnE3ZnvrGs")
  game.StarterGui:SetCore("SendNotification", {
    Icon = "rbxassetid://9300408058";
    Title = "Rainbow HUB : Discord",
    Text = "Copy Link Discord The Clipboard !"
 })
 wait(.1)
end)
