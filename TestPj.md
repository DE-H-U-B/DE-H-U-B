...
local win = library:AddWindow("    MARKxHUB   ")
...
Main2:AddToggle("Auto Farm",Settings.Cum,function(State)
Settings.Cum = State
spawn(function()
    while wait(0.1) do
        pcall(function()
...
Main2:AddToggle("Skip Hatch Egg Anamtion",Settings.No,function(State)
Settings.No = State
